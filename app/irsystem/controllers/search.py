...
lsi = models.LsiModel.load('s3://{}:{}@{}/{}'.format(AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, S3_BUCKET_NAME, 'quotes.model'))
...
def get_s3_url(fname):
    return 's3://{}:{}@{}/{}'.format(AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, S3_BUCKET_NAME, fname)
...
def get_lsi_sim(query, tags=[]): #, wholesome_weight):
    ...
    #lsi = models.LsiModel.load('quotes_likes/quotes.model', mmap='r')
